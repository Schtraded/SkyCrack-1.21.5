package net.straded.skycrack.render.buffer;

import net.fabricmc.fabric.api.client.rendering.v1.WorldRenderContext;
import net.minecraft.util.math.Vec3d;
import net.straded.skycrack.render.shader.Shader;
...
//modifiy vertex and check them translate and transform buffer 1:01.57 https://www.youtube.com/watch?v=K3uFznhp24M